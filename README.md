...
2. Install bower, less and CoffeeScript (`npm install -g bower coffee-script less`) for further package management and the compiling of the assets
...
12. Start server (`./manage.py runserver`) and go to http://localhost:8000

**Note: please do not use (a copy of) the production database for local development.**

## Production deployment

TeamCity automatically deploys the `master` branch to the CH Kubernetes cluster.
