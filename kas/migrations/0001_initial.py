    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_e050",
                    models.IntegerField(default=0, verbose_name="50 eurocent"),
                ),
                (
                    "num_e020",
                    models.IntegerField(default=0, verbose_name="20 eurocent"),
                ),
                (
                    "num_e010",
                    models.IntegerField(default=0, verbose_name="10 eurocent"),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        default=0,
                        verbose_name="total register content",
                        editable=False,
                        blank=True,
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        default=0,
                        verbose_name="cash transactions",
                        editable=False,
                        blank=True,
                    ),
                ),
