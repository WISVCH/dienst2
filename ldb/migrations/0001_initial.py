        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', ldb.country_field.CountryField(blank=True, max_length=2, verbose_name='country',
                                                           choices=[(b'AF', 'Afghanistan'),
                                                                    (b'AX', '\xc5landseilanden'), (b'AL', 'Albani\xeb'),
                                                                    (b'DZ', 'Algerije'), (b'AS', 'Amerikaans-Samoa'),
                                                                    (b'AD', 'Andorra'), (b'AO', 'Angola'),
                                                                    (b'AI', 'Anguilla'), (b'AQ', 'Antarctica'),
                                                                    (b'AG', 'Antigua en Barbuda'),
                                                                    (b'AR', 'Argentini\xeb'), (b'AM', 'Armeni\xeb'),
                                                                    (b'AW', 'Aruba'), (b'AU', 'Australi\xeb'),
                                                                    (b'AT', 'Oostenrijk'), (b'AZ', 'Azerbeidzjan'),
                                                                    (b'BS', "Bahama's"), (b'BH', 'Bahrein'),
                                                                    (b'BD', 'Bangladesh'), (b'BB', 'Barbados'),
                                                                    (b'BY', 'Wit-Rusland / Belarus'),
                                                                    (b'BE', 'Belgi\xeb'), (b'BZ', 'Belize'),
                                                                    (b'BJ', 'Benin'), (b'BM', 'Bermuda'),
                                                                    (b'BT', 'Bhutan'),
                                                                    (b'BO', 'Bolivia, Plurinationale Staat'),
                                                                    (b'BQ', 'Bonaire, Sint Eustatius en Saba'),
                                                                    (b'BA', 'Bosni\xeb en Herzegovina'),
                                                                    (b'BW', 'Botswana'), (b'BV', 'Bouvet'),
                                                                    (b'BR', 'Brazili\xeb'),
                                                                    (b'IO', 'Brits Territorium in de Indische Oceaan'),
                                                                    (b'BN', 'Brunei'), (b'BG', 'Bulgarije'),
                                                                    (b'BF', 'Burkina Faso'), (b'BI', 'Burundi'),
                                                                    (b'KH', 'Cambodja'), (b'CM', 'Kameroen'),
                                                                    (b'CA', 'Canada'), (b'CV', 'Kaap Verde'),
                                                                    (b'KY', 'Kaaimaneilanden'),
                                                                    (b'CF', 'Centraal-Afrikaanse Republiek'),
                                                                    (b'TD', 'Tsjaad'), (b'CL', 'Chili'),
                                                                    (b'CN', 'China'), (b'CX', 'Christmaseiland'),
                                                                    (b'CC', 'Cocoseilanden'), (b'CO', 'Colombia'),
                                                                    (b'KM', 'Comoren'), (b'CG', 'Congo-Brazzaville'),
                                                                    (b'CD', 'Congo-Kinshasa'), (b'CK', 'Cookeilanden'),
                                                                    (b'CR', 'Costa Rica'), (b'CI', 'Ivoorkust'),
                                                                    (b'HR', 'Kroati\xeb'), (b'CU', 'Cuba'),
                                                                    (b'CW', 'Cura\xe7ao'), (b'CY', 'Cyprus'),
                                                                    (b'CZ', 'Tsjechi\xeb'), (b'DK', 'Denemarken'),
                                                                    (b'DJ', 'Djibouti'), (b'DM', 'Dominica'),
                                                                    (b'DO', 'Dominicaanse Republiek'),
                                                                    (b'EC', 'Ecuador'), (b'EG', 'Egypte'),
                                                                    (b'SV', 'El Salvador'),
                                                                    (b'GQ', 'Equatoriaal-Guinea'), (b'ER', 'Eritrea'),
                                                                    (b'EE', 'Estland'), (b'ET', 'Ethiopi\xeb'),
                                                                    (b'FK', 'Falklandeilanden'), (b'FO', 'Faer\xf6er'),
                                                                    (b'FJ', 'Fiji'), (b'FI', 'Finland'),
                                                                    (b'FR', 'Frankrijk'), (b'GF', 'Frans-Guyana'),
                                                                    (b'PF', 'Frans-Polynesi\xeb'), (
                                                               b'TF', 'Franse Zuidelijke en Antarctische Gebieden'),
                                                                    (b'GA', 'Gabon'), (b'GM', 'Gambia'),
                                                                    (b'GE', 'Georgi\xeb'), (b'DE', 'Duitsland'),
                                                                    (b'GH', 'Ghana'), (b'GI', 'Gibraltar'),
                                                                    (b'GR', 'Griekenland'), (b'GL', 'Groenland'),
                                                                    (b'GD', 'Grenada'), (b'GP', 'Guadeloupe'),
                                                                    (b'GU', 'Guam'), (b'GT', 'Guatemala'),
                                                                    (b'GG', 'Guernsey'), (b'GN', 'Guinee'),
                                                                    (b'GW', 'Guinee-Bissau'), (b'GY', 'Guyana'),
                                                                    (b'HT', 'Ha\xefti'),
                                                                    (b'HM', 'Heardeiland en McDonaldeilanden'),
                                                                    (b'VA', 'Vaticaanstad'), (b'HN', 'Honduras'),
                                                                    (b'HK', 'Hong Kong'), (b'HU', 'Hongarije'),
                                                                    (b'IS', 'IJsland'), (b'IN', 'IndiaIndia'),
                                                                    (b'ID', 'Indonesi\xeb'), (b'IR', 'Iran'),
                                                                    (b'IQ', 'Irak'), (b'IE', 'Ierland'), (b'IM', 'Man'),
                                                                    (b'IL', 'Isra\xebl'), (b'IT', 'Itali\xeb'),
                                                                    (b'JM', 'Jamaica'), (b'JP', 'Japan'),
                                                                    (b'JE', 'Jersey'), (b'JO', 'Jordani\xeb'),
                                                                    (b'KZ', 'Kazachstan'), (b'KE', 'Kenia'),
                                                                    (b'KI', 'KiribatiKiribati'), (b'KP', 'Noord-Korea'),
                                                                    (b'KR', 'Zuid-Korea'), (b'KW', 'Koeweit'),
                                                                    (b'KG', 'Kirgizi\xeb'), (b'LA', 'Laos'),
                                                                    (b'LV', 'Letland'), (b'LB', 'Libanon'),
                                                                    (b'LS', 'Lesotho'), (b'LR', 'Liberia'),
                                                                    (b'LY', 'Libi\xeb'), (b'LI', 'Liechtenstein'),
                                                                    (b'LT', 'Litouwen'), (b'LU', 'Luxemburg'),
                                                                    (b'MO', 'Macau'), (b'MK', 'Macedoni\xeb'),
                                                                    (b'MG', 'Madagaskar'), (b'MW', 'Malawi'),
                                                                    (b'MY', 'Maleisi\xeb'), (b'MV', 'Maldiven'),
                                                                    (b'ML', 'Mali'), (b'MT', 'Malta'),
                                                                    (b'MH', 'Marshalleilanden'), (b'MQ', 'Martinique'),
                                                                    (b'MR', 'Mauritani\xeb'), (b'MU', 'Mauritius'),
                                                                    (b'YT', 'Mayotte'), (b'MX', 'Mexico'),
                                                                    (b'FM', 'Micronesi\xeb'), (b'MD', 'Moldavi\xeb'),
                                                                    (b'MC', 'Monaco'), (b'MN', 'Mongoli\xeb'),
                                                                    (b'ME', 'Montenegro'), (b'MS', 'Montserrat'),
                                                                    (b'MA', 'Marokko'), (b'MZ', 'Mozambique'),
                                                                    (b'MM', 'Myanmar'), (b'NA', 'Namibi\xeb'),
                                                                    (b'NR', 'Nauru'), (b'NP', 'Nepal'),
                                                                    (b'NL', 'Nederland'), (b'NC', 'Nieuw-Caledoni\xeb'),
                                                                    (b'NZ', 'Nieuw Zeeland'), (b'NI', 'Nicaragua'),
                                                                    (b'NE', 'Niger'), (b'NG', 'Nigeria'),
                                                                    (b'NU', 'Niue'), (b'NF', 'Norfolk'),
                                                                    (b'MP', 'Noordelijke Marianen'),
                                                                    (b'NO', 'Noorwegen'), (b'OM', 'Oman'),
                                                                    (b'PK', 'Pakistan'), (b'PW', 'Palau'),
                                                                    (b'PS', 'Palestijnse Gebieden'), (b'PA', 'Panama'),
                                                                    (b'PG', 'Papoea-Nieuw-Guinea'), (b'PY', 'Paraguay'),
                                                                    (b'PE', 'Peru'), (b'PH', 'Filipijnen'),
                                                                    (b'PN', 'Pitcairneilanden'), (b'PL', 'Polen'),
                                                                    (b'PT', 'Portugal'), (b'PR', 'Puerto Rico'),
                                                                    (b'QA', 'Qatar'), (b'RE', 'R\xe9union'),
                                                                    (b'RO', 'Roemeni\xeb'), (b'RU', 'Rusland'),
                                                                    (b'RW', 'Rwanda'), (b'BL', 'Saint-Barth\xe9lemy'), (
                                                               b'SH', 'Sint-Helena, Ascension en Tristan da Cunha'),
                                                                    (b'KN', 'Saint Kitts en Nevis'),
                                                                    (b'LC', 'Saint Lucia'), (b'MF', 'Saint-Martin'),
                                                                    (b'PM', 'Saint-Pierre en Miquelon'),
                                                                    (b'VC', 'Saint Vincent en de Grenadines'),
                                                                    (b'WS', 'Samoa'), (b'SM', 'San Marino'),
                                                                    (b'ST', 'Sao Tom\xe9 en Principe'),
                                                                    (b'SA', 'Saoedi-Arabi\xeb'), (b'SN', 'Senegal'),
                                                                    (b'RS', 'Servi\xeb'), (b'SC', 'Seychellen'),
                                                                    (b'SL', 'Sierra Leone'), (b'SG', 'Singapore'),
                                                                    (b'SX', 'Sint Maarten'), (b'SK', 'Slowakije'),
                                                                    (b'SI', 'Sloveni\xeb'), (b'SB', 'Salomonseilanden'),
                                                                    (b'SO', 'Somali\xeb'), (b'ZA', 'Zuid Afrika'), (
                                                               b'GS',
                                                               'Zuid-Georgi\xeb en de Zuidelijke Sandwicheilanden'),
                                                                    (b'ES', 'Spanje'), (b'LK', 'Sri Lanka'),
                                                                    (b'SD', 'Soedan'), (b'SR', 'Suriname'),
                                                                    (b'SJ', 'Spitsbergen en Jan Mayen'),
                                                                    (b'SZ', 'Swaziland'), (b'SE', 'Zweden'),
                                                                    (b'CH', 'Zwitserland'), (b'SY', 'Syri\xeb'),
                                                                    (b'TW', 'Taiwan'), (b'TJ', 'Tadzjikistan'),
                                                                    (b'TZ', 'Tanzania'), (b'TH', 'Thailand'),
                                                                    (b'TL', 'Oost-Timor'), (b'TG', 'Togo'),
                                                                    (b'TK', 'Tokelau-eilanden'), (b'TO', 'Tonga'),
                                                                    (b'TT', 'Trinidad en Tobago'),
                                                                    (b'TN', 'Tunesi\xeb'), (b'TR', 'Turkije'),
                                                                    (b'TM', 'Turkmenistan'),
                                                                    (b'TC', 'Turks- en Caicoseilanden'),
                                                                    (b'TV', 'Tuvalu'), (b'UG', 'Oeganda'),
                                                                    (b'UA', 'Oekra\xefne'),
                                                                    (b'AE', 'Verenigde Arabische Emiraten'),
                                                                    (b'GB', 'Verenigd Koninkrijk'),
                                                                    (b'US', 'Verenigde Staten'), (b'UM',
                                                                                                  'Kleine afgelegen eilanden van de Verenigde Staten'),
                                                                    (b'UY', 'Uruguay'), (b'UZ', 'Oezbekistan'),
                                                                    (b'VU', 'Vanuatu'), (b'VE', 'Venezuela'),
                                                                    (b'VN', 'Vietnam'),
                                                                    (b'VG', 'Maagdeneilanden, Brits'),
                                                                    (b'VI', 'Maagdeneilanden, Amerikaans'),
                                                                    (b'WF', 'Wallis en Futuna'),
                                                                    (b'EH', 'Westelijke Sahara'), (b'YE', 'Jemen'),
                                                                    (b'ZM', 'Zambia'), (b'ZW', 'Zimbabwe')])),
