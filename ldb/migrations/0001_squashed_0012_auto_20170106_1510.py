    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ras_months",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="RAS months"
                    ),
                ),
                (
                    "committee",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ldb.Committee"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "street_name",
                    models.CharField(
                        blank=True, max_length=75, verbose_name="street name"
                    ),
                ),
                (
                    "house_number",
                    models.CharField(
                        blank=True, max_length=7, verbose_name="house number"
                    ),
                ),
                (
                    "address_2",
                    models.CharField(
                        blank=True, max_length=75, verbose_name="address row 2"
                    ),
                ),
                (
                    "address_3",
                    models.CharField(
                        blank=True, max_length=75, verbose_name="address row 3"
                    ),
                ),
                (
                    "postcode",
                ...
                (
                    "country",
                    ldb.country_field.CountryField(
                        blank=True,
                        choices=[
                            ("AF", "Afghanistan"),
                            ("AX", "Ålandseilanden"),
                ...
                (
                    "phone_fixed",
                    models.CharField(
                        blank=True, max_length=16, verbose_name="phone fixed"
                    ),
                ),
                (
                    "machazine",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modification",
                    models.TextField(blank=True, verbose_name="modification"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_prefix",
                    models.CharField(max_length=100, verbose_name="name prefix"),
                ),
                ("name", models.CharField(max_length=100, verbose_name="name")),
                (
                    "name_short",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="name short"
                    ),
                ),
                (
                    "salutation",
                    models.CharField(max_length=100, verbose_name="salutation"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "titles",
                    models.CharField(blank=True, max_length=20, verbose_name="titles"),
                ),
                ...
                (
                    "preposition",
                    models.CharField(
                        blank=True, max_length=15, verbose_name="preposition"
                    ),
                ),
                ...
                (
                    "postfix_titles",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="postfix titles"
                    ),
                ),
                (
                    "phone_mobile",
                    models.CharField(
                        blank=True, max_length=16, verbose_name="phone mobile"
                    ),
                ),
                (
                    "gender",
                ...
                (
                    "deceased",
                    models.BooleanField(default=False, verbose_name="deceased"),
                ),
                (
                    "mail_announcements",
                    models.BooleanField(
                        default=True, verbose_name="announcements mailing"
                    ),
                ),
                (
                    "mail_company",
                    models.BooleanField(default=True, verbose_name="company mailing"),
                ),
                (
                    "ldap_username",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="LDAP username"
                    ),
                ),
                (
                    "netid",
                    models.CharField(blank=True, max_length=32, verbose_name="NetID"),
                ),
                (
                    "linkedin_id",
                    models.CharField(
                        blank=True, max_length=32, verbose_name="LinkedIn ID"
                    ),
                ),
                (
                    "facebook_id",
                    models.CharField(
                        blank=True, max_length=32, verbose_name="Facebook ID"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "study",
                    models.CharField(blank=True, max_length=100, verbose_name="study"),
                ),
                (
                    "study_first_year",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="study first year"
                    ),
                ),
                (
                    "study_last_year",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="study last year"
                    ),
                ),
                (
                    "study_research_group",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="research group"
                    ),
                ),
                (
                    "study_paper",
                    models.CharField(blank=True, max_length=300, verbose_name="paper"),
                ),
                (
                    "study_professor",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="professor"
                    ),
                ),
                (
                    "work_company",
                ...
                (
                    "work_sector",
                    models.CharField(blank=True, max_length=100, verbose_name="sector"),
                ),
                (
                    "contact_method",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount_paid",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="amount paid"
                    ),
                ),
                (
                    "associate_member",
                    models.BooleanField(default=False, verbose_name="associate member"),
                ),
                (
                    "donating_member",
                    models.BooleanField(default=False, verbose_name="donating member"),
                ),
                (
                    "merit_date_from",
                    models.DateField(
                        blank=True, null=True, verbose_name="merit member date from"
                    ),
                ),
                (
                    "merit_invitations",
                    models.BooleanField(
                        default=True, verbose_name="merit member invitations"
                    ),
                ),
                (
                    "merit_history",
                    models.TextField(blank=True, verbose_name="merit member history"),
                ),
                (
                    "honorary_date_from",
                    models.DateField(
                        blank=True, null=True, verbose_name="honorary member from date"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_year",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="first year"
                    ),
                ),
                (
                    "student_number",
                    dienst2.extras.CharNullField(
                        blank=True,
                        max_length=7,
                        null=True,
                ...
                (
                    "graduated",
                    models.BooleanField(default=False, verbose_name="graduated"),
                ),
                (
                    "phone_parents",
                    models.CharField(
                        blank=True, max_length=16, verbose_name="phone parents"
                    ),
                ),
                (
                    "yearbook_permission",
                    models.BooleanField(
                        default=True, verbose_name="yearbook permission"
                    ),
                ),
                (
                    "date_verified",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="ldb.Person"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="ldb.CommitteeMembership", to="ldb.Person"
            ),
        ),
        migrations.AlterField(
            ...
            field=dienst2.extras.CharNullField(
                blank=True, max_length=64, null=True, verbose_name="Facebook ID"
            ),
        ),
        migrations.AlterField(
            model_name="person",
            name="ldap_username",
            field=dienst2.extras.CharNullField(
                blank=True, max_length=64, null=True, verbose_name="LDAP username"
            ),
        ),
        migrations.AlterField(
            model_name="person",
            name="linkedin_id",
            field=dienst2.extras.CharNullField(
                blank=True, max_length=64, null=True, verbose_name="LinkedIn ID"
            ),
        ),
        migrations.AlterField(
            model_name="person",
            name="netid",
            field=dienst2.extras.CharNullField(
                blank=True, max_length=64, null=True, verbose_name="NetID"
            ),
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            sql="UPDATE ldb_student SET student_number = NULL WHERE student_number \
                = '' OR student_number = '0';"
        ),
        migrations.AlterField(
            model_name="person",
        ...
        migrations.RunSQL(
            sql="CREATE INDEX ldb_person_ldap_username_upper ON \
                ldb_person (UPPER(ldap_username));"
        ),
        migrations.RunSQL(
        ...
        migrations.AddField(
            ...
            field=ldb.models.MembershipStatusField(
                db_column="membership_status",
                default=0,
                enum=ldb.models.MembershipStatus,
            ),
        ),
        migrations.AddField(
            model_name="person",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, max_length=100, verbose_name="name prefix"
            ),
        ),
