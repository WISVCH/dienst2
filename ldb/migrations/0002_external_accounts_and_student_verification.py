...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.date_verified'
        db.add_column('ldb_student', 'date_verified',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.netid'
        db.add_column('ldb_person', 'netid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Person.linkedin_id'
        db.add_column('ldb_person', 'linkedin_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Person.facebook_id'
        db.add_column('ldb_person', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


        # Changing field 'Person.living_with'
        db.alter_column('ldb_person', 'living_with_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ldb.Person'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Student.date_verified'
        db.delete_column('ldb_student', 'date_verified')

        # Deleting field 'Person.netid'
        db.delete_column('ldb_person', 'netid')

        # Deleting field 'Person.linkedin_id'
        db.delete_column('ldb_person', 'linkedin_id')

        # Deleting field 'Person.facebook_id'
        db.delete_column('ldb_person', 'facebook_id')


        # Changing field 'Person.living_with'
        db.alter_column('ldb_person', 'living_with_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ldb.Person'], unique=True, null=True))
