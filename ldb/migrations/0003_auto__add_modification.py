...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ldb_modification', (
            ...
            ('modification', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('ldb', ['Modification'])


    def backwards(self, orm):
        # Deleting model 'Modification'
        db.delete_table('ldb_modification')
